    ...
    return(
        <div className="navbar">
            ...
            <div className="navbar-links">
                ...
                {props.page === "/past-events" ? <Link to="/past-events" ><p className="link-selected navbar-link">Past</p></Link> :  <Link to="/past-events" ><p className="navbar-link">Past Events</p></Link>}
